...
// https://simpleicons.org/
export function IconAzure({ size = 24, color = 'currentColor', className = '' }: IconProps) {
    return (
        <svg role="img" viewBox="0 0 24 24" width={size} height={size} xmlns="http://www.w3.org/2000/svg" className={className}>
